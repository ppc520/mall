...
import com.hdkj.mall.express.service.*;
...
import com.hdkj.mall.system.service.*;
...
import com.hdkj.mall.front.service.OrderService;
import com.hdkj.mall.front.vo.OrderInfoDetailVo;
import com.hdkj.mall.front.vo.OrderInfoVo;
...
public class OrderServiceImpl implements OrderService {
    ...
    public MyRecord createOrder(CreateOrderRequest request) {
        ...
        Boolean execute = transactionTemplate.execute(e -> {
            StoreProduct storeProduc =null;
            // 扣减库存
            // 需要根据是否活动商品，扣减不同的库存
            if (storeOrder.getSeckillId() > 0) {// 秒杀扣库存
                MyRecord skuRecord = skuRecordList.get(0);
                storeProduc = storeProductService.getById(skuRecord.getInt("productId"));
                // 秒杀商品扣库存
            ...
            if(storeProduc !=null){
                if(storeProduc.getMerId()!=null && storeProduc.getMerId() !=0){
                    storeOrder.setMerId(storeProduc.getMerId());
                }
            }
