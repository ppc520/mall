...
import com.hdkj.mall.wechat.dao.TemplateMessageDao;
import com.hdkj.mall.wechat.model.TemplateMessage;
import com.hdkj.mall.wechat.request.TemplateMessageSearchRequest;
import com.hdkj.mall.wechat.service.TemplateMessageService;
import com.hdkj.mall.wechat.service.WeChatService;
import com.hdkj.mall.wechat.service.WechatProgramMyTempService;
    ...
    public List<TemplateMessage> getMiniTempList(String type) {
        ...
        switch (type) {
            ...
            case "pink":// 参与拼团
                ...
                break;
            case "newServerOrder":// 新服务订单
                lqw.in(TemplateMessage::getTempKey, Constants.WE_CHAT_PROGRAM_TEMP_KEY_ORDER_NEW);
                break;
            case "serverOrderChane":// 服务订单状态变更
                lqw.in(TemplateMessage::getTempKey, Constants.WE_CHAT_PROGRAM_TEMP_KEY_ORDER_CHANGE);
                break;
            case "recevieOrderChane":// 接单任务状态通知
                lqw.in(TemplateMessage::getTempKey, Constants.WE_CHAT_PROGRAM_TEMP_KEY_ORDER_RECEVIE);
                break;
            case "yueyuOrderChane":// 预约状态提醒
                lqw.in(TemplateMessage::getTempKey, Constants.WE_CHAT_PROGRAM_TEMP_KEY_ORDER_YUEYU);
                break;
