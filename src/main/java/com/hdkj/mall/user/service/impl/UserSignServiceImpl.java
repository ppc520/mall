...
import com.hdkj.mall.user.dao.UserSignDao;
...
public class UserSignServiceImpl extends ServiceImpl<UserSignDao, UserSign> implements UserSignService {
    ...
    public SystemGroupDataSignConfigVo sign() {
        ...
        integralRecord.setIntegral(String.valueOf(configVo.getIntegral()));
        integralRecord.setBalance(String.valueOf(user.getIntegral() + configVo.getIntegral()));
