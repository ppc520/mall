...
public interface UserService extends IService<User> {
     ...
     * @return UserCenterResponse
     */
    UserCenterResponse getUserCenterByid(Integer id);

    CategoryVo getAdminInfoById(Integer id);
    ...
    JSONObject checkSpecialCharactersFun(String content);


    PageInfo<ServiceUserResponse> getListServiceUser(ServiceUser request, PageParamRequest pageParamRequest);

    Boolean saveServiceUser(ServiceUser serviceUser);

    Boolean updateServiceUser(ServiceUser serviceUser);

    Boolean deleteServiceUser(Integer id);

    ServiceUser getInfoServiceUser(Integer id);

    List<ServiceUser> getListServiceUser(ServiceUser serviceUser);
}
