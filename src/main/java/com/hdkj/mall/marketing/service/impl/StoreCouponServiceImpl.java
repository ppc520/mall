package com.hdkj.mall.marketing.service.impl;
...
import com.hdkj.mall.marketing.dao.StoreCouponDao;
    ...
    */
    ...
    public List<StoreCoupon> getList(StoreCouponSearchRequest request, PageParamRequest pageParamRequest) {
        ...
        if(StringUtils.isNotBlank(request.getPrimaryKey())){
            lambdaQueryWrapper.apply(MallUtil.getFindInSetSql("primary_key", request.getPrimaryKey()) + " and use_type = " + request.getUseType());
        }
