...
//                excludePathPatterns("/api/admin/system/role/menu").
        ...
        registry.addInterceptor(adminAuthInterceptor()).
                ...
                excludePathPatterns("/api/admin/getLoginPic").
                excludePathPatterns("/api/admin/payment/callback/**").
                excludePathPatterns("/api/admin/system/store/staff/list").
                 excludePathPatterns("/api/admin/category/list").
                excludePathPatterns("/swagger-resources/**", "/webjars/**", "/v2/**", "/swagger-ui.html/**");
...
//                excludePathPatterns("/api/front/cart/count").
                excludePathPatterns("/api/front/pay/queryTransferResult").
                excludePathPatterns("/api/front/pay/zsxz").
                excludePathPatterns("/api/front/found/topic/listDynamic").
                excludePathPatterns("/api/front/found/topic/banner").
                excludePathPatterns("/api/front/found/acticity/banner").
                excludePathPatterns("/api/front/found/acticity/getlistActicity").
