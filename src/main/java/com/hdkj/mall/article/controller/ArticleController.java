...
import com.hdkj.mall.article.request.ArticleRequest;
...
public class ArticleController {
    ...
    public CommonResult<String> save(@RequestBody @Validated ArticleRequest articleRequest){
        ...
        article.setUrl(systemAttachmentService.clearPrefix(article.getUrl()));
        article.setImage(systemAttachmentService.clearPrefix(article.getImage()));
