package com.hdkj.mall.category.request;
...
public class CategoryRequest implements Serializable {
    ...
    @ApiModelProperty(value = "类型，类型，1 产品分类，2 附件分类，3 文章分类， 4 设置分类， 5 菜单分类， 6 配置分类， 7 秒杀配置,8 话题,9 活动类别,10 大学")
    @NotNull(message = "类型必须选择")
    @Range(min = 1, max = 99, message = "类型，1 产品分类，2 附件分类，3 文章分类， 4 设置分类， 5 菜单分类， 6 配置分类， 7 秒杀配置之间,8 话题,9 活动类别,10 大学") //取值范围
