package com.utils.elias;


import com.utils.elias.cert.CertificateItem;
import com.utils.elias.cert.CertificateList;
import com.utils.elias.cert.PlainCertificateItem;
import com.utils.elias.util.JsonUtils;
...
public class CertificateDownloader implements Runnable {
    ...
    private List<PlainCertificateItem> downloadCertificate() throws IOException, GeneralSecurityException {
        ...
        if (wechatpayCertificatePath == null || wechatpayCertificatePath.equals("")) {
            //不做验签
