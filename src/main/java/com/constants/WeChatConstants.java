...
public class WeChatConstants {
    ...
    //转账到零钱，提现
    public static final String TRANSFERS_API_URI = "mmpaymkttransfers/promotion/transfers";
    //商家转账到零钱
    public static final String TRANSFERS_BATCHES_API_URI = "v3/transfer/batches";
    public static final String TRANSFERS_BATCHES_OUTBATCHNO_API_URI = "v3/transfer/batches/out-batch-no/";
    // 公共号退款
