...
public class Constants {
    ...
    //用户登录密码加密混淆字符串
    public static final String USER_LOGIN_PASSWORD_MD5_KEYWORDS = "hdkj";
...
//    public static final String SKU_STOCK_LIST = "product_stock_list";
    ...
    public static final String CONFIG_TRANSFER_ATTENTION = "transfer_attention"; //提现注意事项
    public static final String CONFIG_TRANSFER_BFB = "transfer_bfb"; //提现手续费
    ...
    public static final String CONFIG_KEY_PAY_ROUTINE_APP_KEY_V3 = "pay_routine_key_v3"; //小程序支付key-v3

    public static final String CONFIG_KEY_PAY_SERIALNO = "paySerialNo"; //商户证书序列号
    public static final String CONFIG_KEY_ROUTINE_CERTIFICATE_PATH = "pay_routine_certificate_path"; //小程序商户私钥证书绝对路径
    public static final String CONFIG_KEY_WECHAT_CERTIFICATE_PATH = "wechat_certificate_path"; //微信平台证书绝对路径
...
//    public static final String CONFIG_KEY_PUBLIC_LOGO = "wechat_avatar"; //公众号logo
    ...
    public static final String USER_BILL_TYPE_PAY_SERVER_ORDER_REFUND = "pay_server_order_refund"; //服务订单退款
    ...
    public static final int ORDER_ATUO_PJ_INT_NUM = 3; //7天自动评价
    ...
    public static final String ORDER_TASK_REDIS_KEY_AFTER_REFUND_BY_USER = "alterOrderRefundByUser"; // 用户商品订单退款后续操作
    public static final String ORDER_FW_TASK_REDIS_KEY_AFTER_REFUND_BY_USER = "alterFwOrderRefundByUser"; // 用户服务订单退款后续操作
    public static final String ORDER_FW_TASK_CREATE_KEY_AFTER_TAKE_BY_USER = "alterFwOrderCreateByUser"; // 用户服务订单创建后自动派单
    public static final String ORDER_FW_TASK_PJ_KEY_AFTER_TAKE_BY_USER = "alterFwOrderPjByUser"; // 用户服务订单完成后自动评价
    ...
    public static final String WE_CHAT_PROGRAM_TEMP_KEY_ORDER_NEW = "12257";// 新订单通知
    public static final String WE_CHAT_PROGRAM_TEMP_KEY_ORDER_RECEVIE = "20634";// 接单任务状态通知
    public static final String WE_CHAT_PROGRAM_TEMP_KEY_ORDER_YUEYU = "14008";// 预约状态提醒
    public static final String WE_CHAT_PROGRAM_TEMP_KEY_ORDER_CHANGE = "3115";// 订单状态变更提醒
    ...
    public static final String CONFIG_XY_JF= "xyjf"; //洗衣得积分
    public static final String CONFIG_HS_JF= "hsjf"; //回收得积分
    public static final String CONFIG_WX_JF= "wxjf"; //维修得积分

    public static final String CONFIG_XY_TIME= "xytime"; //洗衣时间范围
    public static final String CONFIG_HS_TIME= "hstime"; //回收时间范围
    public static final String CONFIG_WX_TIME= "wxtime"; //维修时间范围
    public static final String CONFIG_YY_TIME= "yytime"; //预约时间范围
    public static final String CONFIG_laundry_logo= "laundry_logo"; //洗衣向导图
    public static final String CONFIG_recycle_logo= "recycle_logo"; //回收向导图
    public static final String CONFIG_maintain_logo= "maintain_logo"; //维修向导图
...
//    public static final Integer GROUP_DATA_ID_INDEX_BENEFIT_BANNER = 59;
    ...
    /** 首页精品推荐Banner图片 */
    public static final Integer GROUP_DATA_ID_INDEX_RECOMMEND_BANNER = 48;
    /** 热门榜单推荐Banner图片 */
    public static final Integer GROUP_DATA_ID_INDEX_HOT_BANNER = 48;
    /** 首发新品推荐Banner图片 */
    public static final Integer GROUP_DATA_ID_INDEX_NEW_BANNER = 48;
    /** 首页促销单品推荐Banner图片 */
    public static final Integer GROUP_DATA_ID_INDEX_BENEFIT_BANNER = 48;
    ...
    /** 移动端_拼团列表banner */
    public static final Integer GROUP_DATA_ID_COMBINATION_BANNER = 73;
    /** 活动Banner图片 */
    public static final Integer GROUP_DATA_ID_ACTICITY_BANNER = 74;
    /** 移动端_新首页_Banner滚动图 */
    public static final Integer GROUP_DATA_ID_HOME_BANNER = 75;
    /** 移动端_新首页_活动广告图*/
    public static final Integer GROUP_DATA_ID_HOME_ACTICITY__BANNER = 76;
    /** 新-首页服务菜单 */
    public static final Integer GROUP_DATA_ID_HOME_SEVICE_BANNER = 77;
    /**移动端_论坛_Banner滚动图 */
    public static final Integer GROUP_DATA_ID_TOP_BANNER = 78;


    /** 洗衣-菜单 */
    public static final Integer GROUP_DATA_ID_LAUNDRY_MENUS = 79;
    /** 洗衣_Banner滚动图 */
    public static final Integer GROUP_DATA_ID_LAUNDRY_BANNER = 80;
    /** 维修-菜单*/
    public static final Integer GROUP_DATA_ID_RECYCLE_MENUS = 81;
    /** 维修-Banner滚动图 */
    public static final Integer GROUP_DATA_ID_RECYCLE__BANNER = 82;
    /**回收-菜单 */
    public static final Integer GROUP_DATA_ID_MAINTAIN_MENUS = 83;
    /**回收-Banner滚动图 */
    public static final Integer GROUP_DATA_ID_MAINTAIN_BANNER = 84;
